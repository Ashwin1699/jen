...
namespace CaseStudy
{
    ...
    class App
    {
        ...
        {
            StudentDB student1 = new StudentDB(1, "ashwin", Convert.ToDateTime("16/09/1999"));
            StudentDB student2 = new StudentDB(2, "ani", Convert.ToDateTime("18/07/1999"));
            StudentDB student3 = new StudentDB(3, "abu", Convert.ToDateTime("20/09/1999"));
        ...
        public static void Scenario2()
        {
            ...
            students[0] = new StudentDB(1, "ashwin", Convert.ToDateTime("16/09/1999"));
            students[1] = new StudentDB(2, "ani", Convert.ToDateTime("18/07/1999"));
            students[2] = new StudentDB(3, "abu", Convert.ToDateTime("20/09/1999"));
